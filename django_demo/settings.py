...
SECRET_KEY = "django-insecure-9k%*s--3^n%ztikkawd@88l%ga-vmd8w_y)t7ayedq0=x!3m18"
...
DATABASES = {
    "default": {
        ...
        "NAME": databases_name,  # 数据库名
        "USER": databases_user,  # 用户名
        "PASSWORD": databases_password,  # 密码
        "HOST": databases_host,  # 主机
        "PORT": databases_port,  # 端口
        "OPTIONS": {"charset": "utf8mb4"},  # 字符集
    }
}
